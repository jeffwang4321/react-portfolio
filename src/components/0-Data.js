...
export const work = [
  {
    ...
    duties: [
      ...
      "Refactored and debugged different application’s MVC architecture and SQL Server database connections",
      "Responsible for database scripting, network troubleshooting, jQuery, AJAX and Vue.js debugging",
    ],
    technologies: [".NET Framework", "ASP.NET", "C#", "Microsoft SQL Server", "Vue.js", "Javascript", "jQuery", "AJAX"],
    images: [
    ],
  },
  {
