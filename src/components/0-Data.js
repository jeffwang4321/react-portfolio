...
export const work = [
  {
    ...
    duties: [
      "Developed, maintained, and optimized ASP.NET web applications for Canadian government clients in C#",
      "Refactored and debugged MVC architecture, business billing logic, and SQL Server database connections",
      "Responsible for PHP database scripting, network troubleshooting, jQuery, AJAX, and Vue.js debugging",
    ],
    technologies: [".NET Framework", "ASP.NET", "C#", "SQL", "Microsoft SQL Server", "SSMS", "Vue.js", "Javascript", "jQuery", "AJAX", "PHP", "MVC Architecture"],
    images: [
    ],
  },
  {
    ...
    technologies: ["React.js", "Redux.js", "Cypress.io", "JavaScript", "REST APIs", "AWS", "SASS", "HTML5","Python", "UNIX",  "XML", "Atlassian", "Postman", "Swagger"],
    images: [
...
export const project = [
  {
    ...
    duties: [
      "Developed a cross platform multiplayer browser game using Node.js, Express.js, and Socket.io",
      ...
      "Implemented real-time communication between the client server environment using web sockets (TCP)",
    ],
