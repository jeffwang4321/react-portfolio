...
const allCategories = [
  ...new Set(project.map((project) => project.header)),
  "All",
];
        ...
        content.push(
          <div key={index}>
            <div className="project-info">
              <a
                id="project-git_button"
                href={project[index].github}
                target="_"
              >
                <FaGithub id="project-FaGithub" />
                <b>{project[index].title}</b>
              </a>
              <br />
              <br />
            ...
            return (
              <button
                ...
                className={`project-btn ${
                  item === category && "project-active-btn"
                }`}
              >
                {item}
              </button>
